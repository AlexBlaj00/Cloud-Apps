...
class AdminServices:
    ...
    def admin_groups(user_id):
        admin_groups = []
        url = "http://172.28.115.238:5000/admin_groups/" + str(user_id)
    ...
    def admin_home(user_id):
        perms_list = []
        url = "http://172.28.115.238:5000/admin_home/" +str(user_id)
        response = requests.request("GET", url = url)
        if response:
    ...
    def admin_settings_run(user_id):
        url = "http://172.28.115.238:5000/admin_settings/" + str(user_id)
    ...
    def admin_settings_update(user_id, form):
        url = "http://172.28.115.238:5000/admin_settings_update/" + str(user_id)
        headers = {
    ...
    @staticmethod
    def delete_user_run():
        url = "http://172.28.115.238:5000/delete_user"
        response = requests.request('GET', url= url)
    ...
    def execute_delete_user(delete):
        url = "http://172.28.115.238:5000/delete_user_exec/" 
        for i in delete:
            url += str(i) + ","
        url = url[:-1]
    ...
    @staticmethod
    def admin_add_user():
        url = "http://172.28.115.238:5000/add_user"
        response = requests.request('GET', url = url)
        if response:
            response.status_code == 200
            return response
    ...
    def submit_user_form(form, groups):
        url = "http://172.28.115.238:5000/submit_user/"
        for i in groups:
            url += str(i) + ","
        url = url[:-1]
        headers = {
    ...
    @staticmethod
    def getUser():
        url_users = "http://172.28.115.238:5000/getUsers"
    ...
    @staticmethod
    def getGroups():
        url_groups = "http://172.28.115.238:5000/getGroup"
    ...
    @staticmethod
    def getPerms():
        url_permissions = "http://172.28.115.238:5000/getPermissions"
    ...
    @staticmethod
    def getAllPerms():
        url_permissions = "http://172.28.115.238:5000/getAllPermissions"
        permissions = requests.request('GET', url = url_permissions)
        if permissions:
            permissions.status_code == 200
            return permissions.json()
    ...
    @staticmethod
    def getAllApps():
        url = "http://172.28.115.238:5000/getApps"
    ...
    @staticmethod
    def getApps():
        url = "http://172.28.115.238:5000/getAllApps"
        apps = requests.request('GET', url = url)
        if apps:
            apps.status_code == 200
            return apps.json()
    ...
    def insert_groups(form, users, permission):
        url = "http://172.28.115.238:5000/add_group_run/"
        for i in users:
            url += str(i) + ","
        url = url[:-1]
        url += "/"
    ...
    def insert_perms(form, perms, groups):
        url = "http://172.28.115.238:5000/add_perms_run/"
        for i in groups:
            url += str(i) + ","
        url = url[:-1]
        url += "/"
    ...
    def insert_apps(form):
        url = "http://172.28.115.238:5000/add_apps_run"
    ...
    def delete_group_run():
        url = "http://172.28.115.238:5000/delete_group"
    ...
    def execute_delete_group(delete):
        url = "http://172.28.115.238:5000/delete_group_exec/"
        for i in delete:
            url += str(i) + ","
        url = url[:-1]
        response = requests.request('POST', url = url)
    ...
    @staticmethod
    def delete_perm_run():
        url = "http://172.28.115.238:5000/delete_perm"
        response = requests.request('GET', url = url)
        if response:
            response.status_code == 200
            return response
    ...
    def execute_delete_perm(delete):
        url = "http://172.28.115.238:5000/delete_perm_exec/"
        for i in delete:
            url += str(i) + ","
        url = url[:-1]
        response = requests.request('POST', url = url)
    ...
    @staticmethod
    def delete_app_run():
        url = "http://172.28.115.238:5000/delete_app"
        response = requests.request('GET', url = url)
        if response:
            response.status_code == 200
            return response
    ...
    def execute_delete_app(delete):
        url = "http://172.28.115.238:5000/delete_app_exec/"
        for i in delete:
            url += str(i) + ","
    ...
    def getGroupsMod(user_id):
        url = "http://172.28.115.238:5000/admin_group_modify/" + str(user_id)
        response = requests.get(url)
        if response:
            response.status_code == 200
            return response
    ...
    def getPermsMod(user_id):
        url = "http://172.28.115.238:5000/admin_perms_modify/" + str(user_id)
        response = requests.get(url)
        if response:
            response.status_code == 200
            return response
    ...
    def admin_modify_group(form):
        url = "http://172.28.115.238:5000/admin_modify"
        headers = {
            'Content-Type' : 'application/json'
        }
